...
const CategoryGrid = () => {
  ...
  return (
    <motion.section
      ...
      className="relative py-24 lg:py-32 premium-bg overflow-hidden"
    >
      {/* Background Gradients */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <motion.div
          className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-br from-gold/10 to-transparent rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"
          ...
          {categories.map((cat, index) => (
            ...
            >
              <div className="relative w-full aspect-square rounded-2xl overflow-hidden">
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-t from-premium-bg/60 via-premium-bg/30 to-transparent" />
                </div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
                  {/* Text */}
                  <motion.span
                    className="text-center text-2xl drop-shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 text-white"
                ...
                {/* Border Animation */}
                <motion.div
                  className="absolute inset-0 rounded-2xl border-2 border-transparent group-hover:border-gold/50 transition-all duration-300"
                  initial={{ opacity: 0 }}
