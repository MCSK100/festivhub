...
const events = [
  ...
  {
    id: 3,
    title: 'Neon Brand Activation',
    category: 'Brand Activation',
    image: 'https://images.unsplash.com/photo-1492684223066-87ee7f0b7f37?w=800&auto=format&fit=crop&q=80',
  },
  {
    id: 4,
        ...
        >
          <div>
            ...
            <motion.h2
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-display font-light"
            >
              Featured{' '}
              <span className="gradient-gold">Events</span>
            </motion.h2>
          </div>
          <motion.button
            variants={itemVariants}
            className="btn-secondary mt-6 md:mt-0 inline-flex items-center gap-2"
          >
            <span>View All</span>
        ...
        >
          {events.map((event, index) => (
            ...
            >
              ...
              {/* Overlay */}
              <div className="absolute inset-0 bg-gradient-to-t from-premium-bg via-premium-bg/50 to-transparent" />
              ...
              {/* Hover border */}
              <div className="absolute inset-0 border-2 border-gold/0 group-hover:border-gold/30 rounded-2xl transition-colors" />
            </motion.div>
          ))}
        </motion.div>
      </div>
