...
const videos = [
  {
    id: 1,
    title: 'Grand Innovation Summit 2025',
    description: 'A cutting-edge corporate event featuring immersive tech experiences and world-class speakers.',
    youtubeId: 'dQw4w9WgXcQ',
    category: 'Corporate',
  },
  {
    id: 2,
    title: 'Eclipse Music Festival',
    description: 'Three days of unforgettable music, art installations, and community celebration.',
    youtubeId: '9bZkp7q19f0',
    category: 'Festival',
  },
  {
    id: 3,
    title: 'Celestial Wedding Collection',
    description: 'Breathtaking wedding designs that transform venues into magical experiences.',
    ...
    <section ref={sectionRef} className="relative py-24 lg:py-32 premium-bg overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          >
            Event{' '}
            <span className="gradient-gold">Highlights</span>
          </motion.h2>
          <motion.p
            variants={itemVariants}
          ...
          {videos.map((video, index) => (
            ...
            >
              <div className="glass-card rounded-2xl overflow-hidden">
                ...
                {/* Content */}
                <div className="p-6">
                  <span className="inline-block text-gold text-xs font-medium uppercase tracking-widest mb-2">
                    {video.category}
                  </span>
          ...
          >
            <div className="relative aspect-[21/9]">
              <iframe
                ...
                title="FestivLink - Premium Event Experiences"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
                className="w-full h-full"
                loading="lazy"
            ...
            <div className="p-8 text-center">
              <h3 className="text-2xl lg:text-3xl font-display font-light text-white mb-3">
                Experience the <span className="gradient-gold">FestivLink Difference</span>
              </h3>
              <p className="text-gray-400 max-w-2xl mx-auto">
                From concept to execution, watch how we transform ordinary spaces into extraordinary experiences.
              </p>
            </div>
          </motion.div>
        </motion.div>
