  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="glass-accent rounded-3xl p-6 border border-slate-200"
      >
        ...
        {recentBookings.length === 0 ? (
          ...
          <div className="space-y-4">
            {recentBookings.map((booking) => (
              <div key={booking._id} className="flex items-center justify-between p-4 bg-slate-100 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">{booking.serviceTitle}</p>
                  </div>
                </div>
